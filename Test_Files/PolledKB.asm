...
;
; ECED 3403
; 11 Jul 2023 - XM23 (remove addressing)
...
;
KB_SET	equ	#10	; KB initialization: ENA=1
SCR_SET	equ	#10	; SCR initialization: ENA=1
;
...
; 
	beq	InLoop		; Goto InLoop if DBA = 0
;
...
;
	beq	OutLoop		; Goto OutLoop if DBA = 0
;
; Output done
; Check for 'Z'
;
...
;
	bne 	InLoop		; Goto InLoop if R2 <> 0
;
